...
class TrajectoryBalance:
    ...
    def __init__(
        ...
        # self.xml_dir = hps.get("xml_dir")
        # print("self.xml_dir in tb.py", self.xml_dir)
    ...
    def create_training_data_from_own_samples(
        ...
        xml_dir: Path to save xml files
        log_dir: Path to save performance of robots based on stage (train or valid or final)
        graphs: List[Graph]
    ...
    def create_training_data_from_graphs(self, graphs):
        ...
        """
        # print("oct2_graphsin_tb.py", graphs)
        ...
        # print("trajs o/p from offline data", trajs)
        return trajs
    ...
    def compute_batch_losses(self, model, batch: gd.Batch, num_bootstrap: int = 0):
